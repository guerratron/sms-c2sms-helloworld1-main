...
> Si se prueba en un emulador de momento sólo se muestra un fondo con un logo moviendose por toda 
> la pantalla de la SMS, todo esto con música (Arkanoid) de fondo.
> Aunque se le han implementado una estructura básica de pantallas (inicio, play y gameover)
> El ejemplo termina cuando impacta el mini-corazón contra el logo determinadas veces.
...
- main(): Se encarga de arrancar el ciclo de vida, esto es, la inicialización y la actualización rápida *(update_fast)*, esto habría que tocarlo poco.

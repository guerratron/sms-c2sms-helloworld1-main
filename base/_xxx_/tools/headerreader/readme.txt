...
It does have an unreleased brother that reads Mega Drive/Genesis/32X rom
headers. Maybe you can see that if you ask nicely.
...
The source is in source.zip. It's for Delphi 7. It's a bit messy but I've tried
to comment it up.

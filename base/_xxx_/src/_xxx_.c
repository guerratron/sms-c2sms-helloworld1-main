/**
 * @file main.c
 * @brief Archivo principal que ejecuta el ciclo de vida de la app.
 * @details En general puede reutilizarse en distintos proyectos con pocas modificaciones, ya que los archivos a manipular suelen ser los de la carga de assets y las distintas pantallas. 
 * @author GuerraTron26
 * @date 2026
 * @version 1.0
 */
...
/// @brief el punto de entrada de nuestro código. Ejecuta el cliclo de vida principal.

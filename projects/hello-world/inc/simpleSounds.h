/**
 * @file simpleSounds.h
 * @brief Cabecera para algunas funciones de sonido.
 * @details Un par de funciones para reproducir y silenciar sonidos simples para efectos, del estilo de "beep". Utiliza la función "delay(..)" definida en "basic.h".
 * @author GuerraTron26
 * @date 2026
 * @version 1.0
 */

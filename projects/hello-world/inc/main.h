/**
 * @file main.h
 * @brief Archivo cabecera principal.
 * @details Define las funciones principales del ciclo de vida y el bucle de estados. La función "main()" ejecuta el bucle infinito de la app, es el "punto de entrada".
 * @author GuerraTron26
 * @date 2026
 * @version 1.0
 */
